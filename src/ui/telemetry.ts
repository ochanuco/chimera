...
// PostHog 公式の array.js ローダ snippet（https://posthog.com/docs/libraries/js の HTML snippet installation code を verbatim で再現）。
// posthog.init 呼び出し前の capture 等をキューする stub を window.posthog に仕込み、実体 (array.js) を非同期で読み込む。
